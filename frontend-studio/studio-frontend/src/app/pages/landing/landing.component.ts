    ...
    <div class="min-h-screen bg-[#0a0f1a] text-white font-sans">
      ...
      <div class="max-w-4xl mx-auto px-6 pt-20 pb-12 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-3 justify-center mb-6">
          ...
          <button
            (click)="startAdvanced()"
            class="inline-flex items-center gap-2 border border-teal-700/60 hover:border-teal-500 bg-teal-950/40 hover:bg-teal-900/40 text-teal-300 hover:text-white px-8 py-4 rounded-xl text-base transition-all duration-200"
          >
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
            </svg>
            Advanced Mode (CV upload)
          </button>
        </div>
