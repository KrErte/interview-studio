...
@Component({
  ...
  template: `
    <div class="max-w-3xl mx-auto px-4 py-16">
      <h1 class="text-3xl font-black text-stone-900 mb-2">Terms of Service</h1>
      <p class="text-stone-400 text-sm mb-10">Last updated: March 14, 2026</p>

      <div class="space-y-8 text-stone-600 leading-relaxed">
        <section>
          <h2 class="text-xl font-semibold text-stone-900 mb-3">1. Acceptance of Terms</h2>
          <p>
        ...
        <section>
          <h2 class="text-xl font-semibold text-stone-900 mb-3">2. Description of Service</h2>
          <p>
        ...
        <section>
          <h2 class="text-xl font-semibold text-stone-900 mb-3">3. User Accounts</h2>
        ...
        <section>
          <h2 class="text-xl font-semibold text-stone-900 mb-3">4. Payments & Refunds</h2>
          <p>
        ...
        <section>
          <h2 class="text-xl font-semibold text-stone-900 mb-3">5. Intellectual Property</h2>
          <p>
        ...
        <section>
          <h2 class="text-xl font-semibold text-stone-900 mb-3">6. Disclaimer</h2>
          <p>
        ...
        <section>
          <h2 class="text-xl font-semibold text-stone-900 mb-3">7. Limitation of Liability</h2>
          <p>
        ...
        <section>
          <h2 class="text-xl font-semibold text-stone-900 mb-3">8. Governing Law</h2>
          <p>
        ...
        <section>
          <h2 class="text-xl font-semibold text-stone-900 mb-3">9. Contact</h2>
          <p>
            Questions about these terms? Contact us at:
            <a href="mailto:info&#64;careerisk.ee" class="text-red-600 hover:underline">info&#64;careerisk.ee</a>
          </p>
        </section>
      </div>
    </div>
