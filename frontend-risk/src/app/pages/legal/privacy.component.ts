      ...
      <div class="space-y-8 text-slate-300 leading-relaxed">
        ...
        <section>
          ...
          <ul class="list-disc list-inside space-y-2 text-slate-400">
            <li><span class="text-slate-300">Account data:</span> email address, name (when you register)</li>
            <li><span class="text-slate-300">Assessment data:</span> target role, experience level, challenges, CV text (when provided)</li>
            <li><span class="text-slate-300">Usage data:</span> pages visited, features used, session duration</li>
            <li><span class="text-slate-300">Payment data:</span> processed securely by our payment provider (we do not store card details)</li>
          </ul>
        </section>
        ...
        <section>
          <h2 class="text-xl font-semibold text-white mb-3">5. Data Retention</h2>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            <a href="mailto:privacy&#64;careerisk.ee" class="text-emerald-400 hover:underline">privacy&#64;careerisk.ee</a>
          </p>
        </section>
      </div>
    </div>
