    ...
    <div class="max-w-5xl mx-auto px-4 py-12">
      ...
      <div class="flex flex-wrap items-center justify-center gap-6 mb-10 py-4 px-6 bg-stone-100 border border-stone-200">
        <div class="flex items-center gap-2 text-sm">
          <svg class="w-4 h-4 text-stone-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
          <span class="text-stone-500">Secure payment via Stripe</span>
        </div>
        <div class="w-px h-4 bg-stone-300 hidden sm:block"></div>
        <div class="flex items-center gap-2 text-sm">
          <span class="text-stone-500">Cancel anytime</span>
        </div>
        <div class="w-px h-4 bg-stone-300 hidden sm:block"></div>
        <div class="flex items-center gap-2 text-sm">
          <span class="text-stone-500">100% money-back guarantee</span>
        </div>
      </div>
